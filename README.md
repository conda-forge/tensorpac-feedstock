...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tensorpac-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15378&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tensorpac-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tensorpac` can be installed with:

```
conda install tensorpac
```

It is possible to list all of the versions of `tensorpac` available on your platform with:
